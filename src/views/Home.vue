<template>
  ...
  <div class="relative pt-6 pb-16 sm:pb-24 lg:pb-32">
    ...
    <main class="mt-8 mx-auto max-w-7xl px-4 sm:mt-24 sm:px-6 lg:mt-32">
        <div class="mt-8 mx-auto max-w-7xl px-4 sm:mt-24 sm:px-6">
          <div class="text-center">
            ...
            <p class="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
              Augment your prized punks* and display them in our handcrafted frames.
            </p>
            
            <div class="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8 mt-8">
            <div class="flex justify-center">
              <div class="mr-16">
                  <a class="flex items-center text-blue-500 hover:text-blue-700 " href="https://twitter.com/FramedPunks" target="_blank">
                    ...
                    <span class="inline ml-2"><span class="hidden md:inline">Follow us on </span>Twitter</span>
                  </a>
              </div>
              <div>
                  <a class="flex items-center text-blue-500 hover:text-blue-700 " href="https://opensea.io/collection/framed-punks-v2" target="_blank">
                    ...
                    <span class="inline ml-2"><span class="hidden md:inline">Find us on </span>OpenSea</span>
                  </a>
              </div>
            </div>
          </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 my-8 sm:my-12 lg:my-24">
          <artwork
...
export default {
  ...
  methods : {
    getRandomPunkId() {
      return Math.floor(Math.random() * this.maxPunkId).toString().padStart(4, '0')
    },
    getRandomFrameId() {
